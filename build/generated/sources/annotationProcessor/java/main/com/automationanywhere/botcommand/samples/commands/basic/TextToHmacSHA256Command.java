...
public final class TextToHmacSHA256Command implements BotCommand {
  private static final Logger logger = LogManager.getLogger(TextToHmacSHA256Command.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    TextToHmacSHA256 command = new TextToHmacSHA256();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("value"),(String)convertedParameters.get("key"),(String)convertedParameters.get("OutputType")));
